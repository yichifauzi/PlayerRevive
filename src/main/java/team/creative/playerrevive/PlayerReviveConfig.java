...
public class PlayerReviveConfig {
    ...
    public static class Bleeding {
        ...
        @CreativeConfig
        public List<MobEffectConfig> bleedingEffects = Arrays.asList(new MobEffectConfig(Registry.MOB_EFFECT, new ResourceLocation("minecraft", "slowness"), 2, 10, true));
    ...
    public static class Revive {
        ...
        @CreativeConfig
        public List<MobEffectConfig> revivedEffects = Arrays.asList(new MobEffectConfig(Registry.MOB_EFFECT, new ResourceLocation("minecraft", "slowness"), 2, 1, true));
